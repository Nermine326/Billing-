...
function Header()
{
$this->Image('images/sigle-fond.jpg','24','70','166','160','jpg');
}
...
function Footer()
{
    ...
    //Num̩ro et nombre de pages
    $this->Text(80,290,utf8_decode('Pdf g̩n̩r̩ le '.date('d/m/Y')).'   Page '.$this->PageNo().'/{nb}');
}
